...
def Playlist(page: ft.Page):
    ...
    def toggle_song_info(track):
        song_info.controls = [SongInfo2(track=track,close=close),ft.Container(height=2e9)]
    ...
    file_picker = ft.FilePicker(on_result=import_playlist)
