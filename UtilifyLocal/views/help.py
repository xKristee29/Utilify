...
### **Cum descarc o melodie?**

Pentru a descărca o melodie, trebuie să apăsați pe butonul de descărcare din panoul de informații a melodiei respective. Va apărea o fereastră în care se poate observa progresul descărcării. Melodia va fi descărcată în folderul specificat în setări. 
...
### **Cum salvez un playlist?**

Pentru a salva un playlist accesează pagina de playlist și apasă pe butonul de salvare din partea de sus a paginii. Playlistul va fi salvat cu numele ales în folderul specificat în setări.

### **Cum încarc un playlist?**

Pentru a încărca un playlist accesează pagina de playlist și apasă pe butonul de încărcare din partea de sus a paginii. Apoi vei alege din calculator playlistul pe care vrei să îl încarci.
